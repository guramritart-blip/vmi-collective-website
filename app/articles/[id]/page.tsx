      ...
      <section className="relative py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-[#0a0a0a] text-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="mb-3 sm:mb-4">
            <span className="px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-[#00d4ff] to-[#0066ff] text-white text-xs sm:text-sm font-semibold rounded-full">
              {article.category}
            </span>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-sm sm:text-base text-[#b0b0b0] px-2">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-lg max-w-none">
            <div className="bg-[#151515] border border-[#252525] rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 md:p-12">
              ...
              <div className="text-base sm:text-lg md:text-xl text-[#b0b0b0] leading-relaxed space-y-4 sm:space-y-6">
