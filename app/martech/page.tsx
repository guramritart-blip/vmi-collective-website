      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#151515] border border-[#252525] rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 md:p-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">About MarTech</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-12">
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">CRM Integration</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Seamless integration with leading CRM platforms to streamline customer relationship management.</p>
              </div>
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Marketing Automation</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Automate marketing workflows and campaigns to improve efficiency and effectiveness.</p>
              </div>
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Analytics Tools</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Advanced analytics and reporting tools to measure and optimize marketing performance.</p>
              </div>
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Data-Driven Strategies</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Leverage data insights to develop marketing strategies that deliver measurable ROI.</p>
              </div>
            </div>
