      ...
      <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#151515] border border-[#252525] rounded-xl sm:rounded-2xl shadow-xl p-6 sm:p-8 md:p-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-6">About Creative</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mt-8 sm:mt-12">
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Brand Identity Design</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Create distinctive brand identities that resonate with your target audience and reflect your values.</p>
              </div>
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Digital Content Creation</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Engaging digital content including graphics, videos, and interactive media.</p>
              </div>
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Multimedia Production</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Professional video, audio, and multimedia production services.</p>
              </div>
              <div className="bg-[#111111] border border-[#252525] rounded-xl p-5 sm:p-6">
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Creative Strategy</h3>
                <p className="text-sm sm:text-base text-[#b0b0b0]">Strategic creative planning to ensure your brand message is impactful and memorable.</p>
              </div>
            </div>
